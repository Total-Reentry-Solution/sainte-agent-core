...
st.set_page_config(
    page_title="SAINTE Agent | Emotional Intelligence Core",
    page_icon="🧠",
    layout="wide"
)
...
with tab1: render_checkin_form(API_BASE)
with tab2: render_history_feed(API_BASE)
with tab3: render_emotion_chart(API_BASE)
render_footer()
